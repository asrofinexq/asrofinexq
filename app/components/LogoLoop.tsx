...
const useAnimationLoop = (
  ...
  useEffect(() => {
    ...
    const hasDynamicHoverSpeed = hoverSpeed !== undefined;
    ...
    return (
      ...
      >
        ...
        <div
          className={cx(
            "logoloop__track",
            isVertical ? "logoloop__track--vertical" : "logoloop__track--horizontal",
          )}
          ref={trackRef}
